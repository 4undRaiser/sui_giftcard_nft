...
module sui_giftcard_nft::giftcard_royalty_rule {
    use sui::sui::SUI;
    ...
    use sui::transfer_policy::{
     ...
     use sui_giftcard_nft::giftcard_nft::{GIFTCARD};
    ...
    public fun add<GIFTCARD>(
        policy: &mut TransferPolicy<GIFTCARD>,
        cap: &TransferPolicyCap<GIFTCARD>,
        amount_bp: u16,
        min_amount: u64
    ...
    public fun pay(
        policy: &mut TransferPolicy<GIFTCARD>,
        request: &mut TransferRequest<GIFTCARD>,
        payment: Coin<SUI>
    ) {
    ...
    public fun fee_amount(policy: &TransferPolicy<GIFTCARD>, paid: u64): u64 {
